/**
 * Created by session1 on 10/11/16.
 */
...
function main() {
    ...
    vehicleArray[0]= new Vehicle("Generic Vehicle", 0, "kps", 0.00);

    vehicleArray[1]= new Car("Porsche Carrera", 195, "mph", 84000.00, 4);

    vehicleArray[2]= new Sailboat("Hinckley SW52", 35, "knots", 498000.00, 1);

    vehicleArray[3] = new Truck("Toyota", "idk", "mph", 24000.00, 4);
